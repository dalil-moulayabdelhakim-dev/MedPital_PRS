            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu show" id="homeSubmenu2">
                        <li class="active"><a class="list-item" href="{{route('patient.requests.page')}}"><p>Patients</p> <span class="badge">{{$settings['pat_req']}}</span></a></li>
                            ...
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                        <h2 class="ml-lg-2">Manage Patient</h2>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @if ($settings['users']->count() > 0)
                                        @foreach ($settings['users'] as $patient)
                                            <tr>
                                                ...
                                                <td>
                                                    <button id="view-btn" href="#addEmployeeModal" data-toggle="modal"
                                                        ...
                                                        onclick="fetchUserData({{ $patient->id }})">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>Gender</label>
                                        <label id="gender" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Date of birth</label>
                                        <label id="date_of_birth" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
